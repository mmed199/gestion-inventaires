                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th><?php echo $this->Paginator->sort('Id', 'Absence.id'); ?></th>
                                                    <th><?php echo $this->Paginator->sort('Type d\'absence', 'Typeabsence.title'); ?></th>
                                                    <th><?php echo $this->Paginator->sort('Année', 'Annee.titre'); ?></th>
                                                    <th><?php echo $this->Paginator->sort('Durée', 'Absence.duree'); ?></th>
                                                    <th><?php echo $this->Paginator->sort('Date de demande', 'Absence.created'); ?></th>
                                                    <th><?php echo $this->Paginator->sort('Décision', 'Absence.decision'); ?></th>
                                            ...
                                            <tbody>
                                                <?php foreach($absences as $a ) : ?>
                                                    <tr>
                                                        ...
                                                        <?php } ?>  
                                                        <td>
                                                            <a href="/absences/<?php echo $a['Typeabsence']['slug'] ; ?>-<?php echo $a['Absence']['id'] ; ?>.html" title ="Afficher"> <button class="btn btn-default icon-only" type="button">
                                                                <i class="fa fa-eye"></i>
                                                            </button></a>
                                                     <?php if ($a['Absence']['envoyer']==1) { ?>
                                                        <?php if ($a['Absence']['decision']==2) { ?>
                                                            <?php if ($a['Absence']['satisfaction']==0) { ?>
                                                                <a href="/member/absences/modifier/<?php echo $a['Absence']['id'] ; ?>" title ="Modifier">
                                                                    <button class="btn btn-default icon-only" type="button"><i class="fa fa-edit"></i></button>
                                                                </a>
                                                            <?php } else { ?>
                                                                <a href="#" title ="Satisfaction">
                                                    ...
                                                    <?php } ?>
                                                    <?php if ($a['Absence']['envoyer']==0) { ?>
                                                             <a href="/member/absences/supprimer/<?php echo $a['Absence']['id'] ; ?>" class="ask" title ="Supprimer">
                                                                <button class="btn btn-default icon-only" type="button"><i class="fa fa-trash-o"></i></button>
                                                            </a>
                                                    <?php }else if($a['Absence']['envoyer']==1 && $a['Absence']['decision']!=0) { ?>
