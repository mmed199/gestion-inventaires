    ...
    <div class="container-fluid">
        <div class="row page-title-div">
            <div class="col-sm-6">
                ...
                <p class="sub-title">Gestion des Typemateriels</p>
            </div>
        </div>
        <!-- /.row -->
        <div class="row breadcrumb-div">
            ...
            <div class="col-md-6 text-right">
                <a href="/admin/typemateriels/ajouter"><i class="fa fa-plus"></i><span>Ajouter</span></a>
            </div>
        </div>
        <!-- /.row -->
    </div>
    ...
    <section class="section"> 
        <div class="container-fluid">
                            ...
                            <div id="example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                <div class="row"> 
                                    <div class="col-sm-12">
                                        ...
                                        <?php echo $form->create('Typemateriel',array('action'=>'rechercher') ) ; ?>
            ...
            &nbsp;
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <?php if(!empty($typemateriels) ) : ?>
                                        <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                            <tr>
                                  
                                   <th><?php echo $this->Paginator->sort('Titre de Typemateriel', 'Typemateriel.tilte'); ?>&nbsp;<i class="fa fa-sort"></i></th>
                                   
                                   <th><?php echo $this->Paginator->sort('Slug', 'Typemateriel.slug'); ?>&nbsp;<i class="fa fa-sort"></i></th>
                                   <th><?php echo $this->Paginator->sort('Nomre de Materiel', 'Typemateriel.nbr_mat'); ?>&nbsp;<i class="fa fa-sort"></i></th>
                                            ...
                                            <tbody>
                                                <?php foreach($typemateriels as $m ) : ?>
                                                    <tr>
                                                    
                                                        <td><?php echo $m['Typemateriel']['title'] ; ?></td>
                                                        <td><?php echo $m['Typemateriel']['slug'] ; ?></td>
                                                        <td><?php echo $m['Typemateriel']['nbr_mat'] ; ?></td>
                                                        ...
                                                        <td>
                                                            <a href="/admin/typemateriels/afficher/<?php echo $m['Typemateriel']['id'] ; ?>" title ="Afficher"> 
                                                                <button class="btn btn-default icon-only" type="button">
                                                                    <i class="fa fa-eye"></i>
                                                                </button>
                                                            </a>
                                                            <a href="/admin/typemateriels/modifier/<?php echo $m['Typemateriel']['id'] ; ?>" title ="Modifier"><button class="btn btn-default icon-only" type="button">
                                                                <i class="fa fa-edit"></i>
                                                            </button></a>
                                                            <a href="/admin/typemateriels/supprimer/<?php echo $m['Typemateriel']['id'] ; ?>" class="ask" title ="Supprimer"><button class="btn btn-default icon-only" type="button">
                                        ...
                                        <?php else : ?>
                                            <div class="alert alert-default bg-warning">
                                                ...
                                                Aucun typemateriel n'a été trouvé !
                                            </div>
                                        <?php endif ; ?>    
                                    </div>
                                </div>
