...
class CksourceHelper extends FormHelper {
    ...
    function ckeditor($fieldName, $options = array()) {
        ...
        $value = null;
        $config = array('filebrowserBrowseUrl' => '/js/ckfinder/ckfinder.html',
						'filebrowserImageBrowseUrl' => '/js/ckfinder/ckfinder.html?type=Images',
						'filebrowserUploadUrl' => '/js/ckfinder/ckfinder.html',
						'filebrowserImageUploadUrl' => '/js/ckfinder/ckfinder.html?type=Images',
						'ImageBrowser'=>true,
						);
        $events = null;
