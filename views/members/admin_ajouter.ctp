        ...
        <?php echo $form->create('Member',array('id'=>'formID','class'=>"niceform",'type'=>'file')); ?>
            <fieldset>
                ...
                <dl>
                    ...
                    <dd><?php echo $form->input('Member.imagePre', array('type' => 'file','label' =>'' ));?>
                    </dd>
                </dl>
                <dl>
                    <dt><label for="type_compte">Type de compte : </label></dt>
                    <dd><?php echo $form->input('Member.type_compte',array(
                                        'label'=>false,
                                        'type' => 'select',
                ...
                <dl>
                    ...
                    <dd>
                        <?php echo $form->input('Member.city_id',array("class"=>" validate[required] newfleurinput ",'type' => 'select','options' =>array('escape' => "------------------",$villes),  'label' =>false));?>
                    </dd>
                </dl>
                <dl class="submit">
