...
<div class="main-page">
    <div class="container-fluid">
        <div class="row page-title-div">
            <div class="col-md-6">
                <h4 class="title">Mon profil: <small class="ml-10"><?php echo ucfirst($session->read('Auth.User.nom'));  ?> <?php echo ucfirst($session->read('Auth.User.prenom'));  ?></small></h4>
        ...
        <div class="row breadcrumb-div">
            ...
            <div class="col-md-6 text-right">
                <a href="/admin/users/editProfil" class="pl-20"><i class="fa fa-cog"></i> Modifier mon profil</a>
            </div>
            <!-- /.col-md-6 -->
        </div>
        <!-- /.row -->
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <img src="<?php echo '/uploads/users/'.$user['User']['logo'] ; ?>" alt="<?php echo $session->read('Auth.User.nom');  ?> <?php echo $session->read('Auth.User.prenom');  ?>" class="img-circle profile-img" style = "height: 200px; width: 200px; ">
                                <div class="text-center">
                                    <a href="/admin/users/edit_photo" type="button" class="btn btn-primary btn-xs btn-labeled mt-10">Modifier l'image<span class="btn-label btn-label-right"><i class="fa fa-pencil"></i></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-striped">
                            	<tbody>
                            		...
                            		<tr>
                            			...
                            			<td><?php echo date('d/m/Y',strtotime($user['User']['d_d_con'])); ?><br>
                                            <small class="color-warning"><?php echo afficher_date($user['User']['d_d_con']) ; ?></small>
                                        </td>
                            		</tr>
                            	</tbody>
                            </table>
            ...
            <div class="col-md-9">
                ...
                <div class="tab-content bg-white p-15">
                    ...
                    <div role="tabpanel" class="tab-pane" id="experience">
                        <p>
                            <?php echo $user['User']['experiences']; ?>       
                        </p>
                    </div>
                    <div role="tabpanel" class="tab-pane" id="poste">
                       <?php echo $user['User']['poste_actuel']; ?>  
                    </div>
                    <div role="tabpanel" class="tab-pane" id="adresses">
                         <p>
                            <strong> Numéro de téléphone fix: </strong><?php echo $user['User']['telephone']; ?>  <br>
                            <strong> GSM: </strong><?php echo $user['User']['mobile']; ?>  <br>
                            <strong> Adresse E-mail: </strong><?php echo $user['User']['email']; ?>  <br>
                            <strong> Adresse: </strong><?php echo $user['User']['adresse']; ?> <?php echo $user['User']['adresse_suite']; ?> 
                         </p>
                    </div>
                    <!-- /.section-title -->
                </div>
