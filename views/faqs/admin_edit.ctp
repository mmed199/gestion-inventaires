...
<div class="form">
            <?php echo $form->create('Faq',array('id'=>'formID','enctype'=>'multipart/form-data','class'=>"niceform")); ?>
                <fieldset>
				<dl><?php echo $form->hidden('cfaq_id');?>
				...
				<dl>
					...
					<dd>
						<textarea name="data[Faq][reponse]" rows="8" cols="60"><?php echo $this->data['Faq']['reponse'];?></textarea>
