 ...
 <div class="main-page">
    <div class="container-fluid">
        <div class="row page-title-div">
            <div class="col-sm-6">
                <h2 class="title">Gestion emplacement</h2>
                <p class="sub-title">La gestion emplacement............</p>
            </div>
        </div>
        <!-- /.row -->
        <div class="row breadcrumb-div">
            ...
            <div class="col-md-6 text-right">
                <a href="/admin/materiels/ajouter"><i class="fa fa-plus"></i><span>Ajouter</span></a>
            </div>
        </div>
        <!-- /.row -->
    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                            <tr>
                                                <th><?php echo $this->Paginator->sort('Id', 'Materiel.id'); ?>&nbsp;<i class="fa fa-sort"></i></th>
                                                <th><?php echo $this->Paginator->sort('Nom du Materiel', 'Materiel.nom'); ?>&nbsp;<i class="fa fa-sort"></i></th>
                                                <th><?php echo $this->Paginator->sort('Date de création', 'Materiel.created'); ?>&nbsp;<i class="fa fa-sort"></i></th>
