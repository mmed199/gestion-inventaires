<div id="contenu-entete">
	<div id="contenu-titre">
		<h2>Détail du message "contact"</h2>
	</div>
	<div id='contenu-actions'>
		<a href="/admin/messages/repondre/<?php echo $message['Message']['id'] ; ?>" title="Répondre"><img src="/_admin/img/mail_reply.png" alt="Répondre"  ></a>
		<!-- <a href="/admin/messages/modifier/<?php echo  $message['Message']['id']  ; ?>" title="Modifier"><img src="/_admin/img/edit.png" alt="Modifier"></a> -->
...
<div id="entete-member">
	<div id="entete-member-col-2">
		<span class="dlabel">Envoyé par :</span>
