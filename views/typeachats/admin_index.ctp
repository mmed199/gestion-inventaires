    ...
    <div class="container-fluid">
        <div class="row page-title-div">
            <div class="col-sm-6">
                ...
                <p class="sub-title">Gestion des Typeachats</p>
            </div>
        </div>
        <!-- /.row -->
        <div class="row breadcrumb-div">
            <div class="col-sm-6">
                <ul class="breadcrumb">
                    ...
                    <li><a href="/admin/achats/index">Gestion d'inventaires</a> </li>
                    
                </ul>
            </div>
            <div class="col-md-6 text-right">
                <a href="/admin/typeachats/ajouter"><i class="fa fa-plus"></i><span>Ajouter</span></a>
            </div>
        </div>
        <!-- /.row -->
    </div>
    ...
    <section class="section"> 
        <div class="container-fluid">
                            ...
                            <div id="example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                <div class="row"> 
                                    <div class="col-sm-12">
                                        ...
                                        <?php echo $form->create('Typeachat',array('action'=>'rechercher') ) ; ?>
            ...
            &nbsp;
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <?php if(!empty($typeachats) ) : ?>
                                        <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                            <tr>
                                  
                                   <th><?php echo $this->Paginator->sort('Titre de Typeachat', 'Typeachat.tilte'); ?>&nbsp;<i class="fa fa-sort"></i></th>
                                   
                                   <th><?php echo $this->Paginator->sort('Slug', 'Typeachat.slug'); ?>&nbsp;<i class="fa fa-sort"></i></th>
                                   <th><?php echo $this->Paginator->sort('Nomre de achat', 'Typeachat.nbr_mat'); ?>&nbsp;<i class="fa fa-sort"></i></th>
                                            ...
                                            <tbody>
                                                <?php foreach($typeachats as $m ) : ?>
                                                    <tr>
                                                    
                                                        <td><?php echo $m['Typeachat']['title'] ; ?></td>
                                                        <td><?php echo $m['Typeachat']['slug'] ; ?></td>
                                                        <td><?php echo $m['Typeachat']['nbr_mat'] ; ?></td>
                                                        ...
                                                        <td>
                                                            <a href="/admin/typeachats/afficher/<?php echo $m['Typeachat']['id'] ; ?>" title ="Afficher"> 
                                                                <button class="btn btn-default icon-only" type="button">
                                                                    <i class="fa fa-eye"></i>
                                                                </button>
                                                            </a>
                                                            <a href="/admin/typeachats/modifier/<?php echo $m['Typeachat']['id'] ; ?>" title ="Modifier"><button class="btn btn-default icon-only" type="button">
                                                                <i class="fa fa-edit"></i>
                                                            </button></a>
                                                            <a href="/admin/typeachats/supprimer/<?php echo $m['Typeachat']['id'] ; ?>" class="ask" title ="Supprimer"><button class="btn btn-default icon-only" type="button">
                                        ...
                                        <?php else : ?>
                                            <div class="alert alert-default bg-warning">
                                                ...
                                                Aucun typeachat n'a été trouvé !
                                            </div>
                                        <?php endif ; ?>    
                                    </div>
                                </div>
