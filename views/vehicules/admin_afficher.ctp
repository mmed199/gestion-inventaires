 <div class="main-page">
    <div class="container-fluid">
        <div class="row page-title-div">
            <div class="col-sm-6">
                <h2 class="title">Gestion Parc-Auto</h2>
                <p class="sub-title">La gestion des vehicules.</p>
            </div>
        </div>
        <!-- /.row -->
        <div class="row breadcrumb-div">
            <div class="col-sm-6">
                <ul class="breadcrumb">
                    ...
                    <li class="active">détail vehicule</li>
                </ul>
            </div>
           <div class="col-md-6 text-right">
                <a href="/admin/vehicules/ajouter"><i class="fa fa-plus"></i><span>Ajouter une vehicule</span></a>
            </div>
        </div>
        <!-- /.row -->
    </div>
