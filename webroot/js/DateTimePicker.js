...
var imageFilesPath = "/_admin/images/calendar/"; //Path of date time picker image files relative to HTML page.
...
function RenderCssCal(bNewCal) {
    ...
    if (Cal.ShowTime === true) {
        ...
        vCalTime += "<td width='33px'><input type='text' name='hour' maxlength=2 size=1 style=\"width:33px\" value=" + showHour + " onkeyup=\"javascript:Cal.SetHour(this.value)\">";
        vCalTime += "</td><td style='font-weight:bold;text-align:center;'>:</td><td width='33px'>";
        vCalTime += "<input type='text' name='minute' maxlength=2 size=1 style=\"width: 33px\" value=" + Cal.Minutes + " onkeyup=\"javascript:Cal.SetMinute(this.value)\">";

        if (Cal.ShowSeconds) {
            vCalTime += "</td><td style='font-weight:bold;'>:</td><td width='33px'>";
            vCalTime += "<input type='text' name='second' maxlength=2 size=1 style=\"width: 33px\" value=" + Cal.Seconds + " onkeyup=\"javascript:Cal.SetSecond(parseInt(this.value,10))\">";
        }
