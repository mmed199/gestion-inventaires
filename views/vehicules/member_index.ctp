        ...
        <div class="row breadcrumb-div">
            <div class="col-sm-6">
                <ul class="breadcrumb">
                    ...
                    <li><a href="/gestion-indemnites.html">Gestion des indemnités</a> </li>
                    <li class="active">Gestion des indemnités</li>
                </ul>
            </div>
            <div class="col-md-6 text-right">
                <a href="/absences/ajouter"><i class="fa fa-plus"></i><span>Ajouter</span></a>
            </div>
        </div>
        <!-- /.row -->
    </div>
                                            ...
                                            <tbody>
                                                <?php foreach($absences as $a ) : ?>
                                                    <tr>
                                                        ...
                                                        <?php }else if ($a['Absence']['decision']==2) { ?>
                                                        <td>
                                                        ...
                                                        <?php } ?> 
                                                        <td>
                                                            <a href="/absences/afficher/<?php echo $a['Absence']['id'] ; ?>" title ="Afficher"> 
