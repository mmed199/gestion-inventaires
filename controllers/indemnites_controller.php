<?php
class IndemnitesController extends AppController{
    var $name ="Indemnites";
	...
	var $paginate = array(
							...
							'fields'=>"Indemnite.id, 
									   Indemnite.created, 
									   Indemnite.date_debut, 
									   Indemnite.date_fin, 
									   Indemnite.nombre, 
									   Indemnite.brut, 
									   Indemnite.loi_finance, 
									   Indemnite.nombre, 
									   Indemnite.retenues, 
									   Indemnite.objet,  
									   Indemnite.deleted" ,
...
//----------------------------------------- Admin ----------------------------------------------	
	...
	function admin_index(){ 
		...
		$this->set('balise_h5',"Liste des indemnités");
	...
	function admin_ajouter(){
		...
		$this->data["Indemnite"]["date_fin"] = $date_debut_fr;
       	...
       	if( $this->Indemnite->save($this->data) ){
			...
			$this->Session->setFlash("La nouvelle demande d'Indemnite a bien été  ajoutée.","default",array('class'=>'valid_box'));

			$this->Session->setFlash("
					<button class='close' aria-label='Close' data-dismiss='alert' type='button'>
						<span aria-hidden='true'>×</span>
					</button>
					La nouvelle demande d'Indemnite a bien été ajoutée.",
	...
	function admin_afficher($id){
		...
		$this->loadModel('TypeIndemnite');		
		$Indemnite_id = $this->Indemnite->find('first',array('conditions'=>array('Indemnite.id'=>$id)));	

		$this->set('indemnite',$q) ;

		$this->set('indemnite_id',$id) ; 

		$page_title = "Détail de l'indemnité N° ".$q["Indemnite"]["id"] ;
