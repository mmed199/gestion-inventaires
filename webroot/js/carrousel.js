...
var carrousel = {
    ...
    init : function(elem){
        ...
        this.elem.find(".navigation").css("opacity",.99);   // On rend la navigation opaque
    ...
    gotoSlide : function(num){
        ...
        var cssDeb = { "left" : sens*(this.elem.width()+10) };
        var cssFin = { "left" : -sens*(this.elem.width()+10) };
        this.elem.find("#slide"+num).show().css(cssDeb);
        this.elem.find("#slide"+num).animate({"bottom":0,"left":0},800);
