...
<div class="main-page">
    <div class="container-fluid">
        <div class="row page-title-div">
            <div class="col-md-6">
                <h4 class="title">Informations sur le membre : <small class="ml-10"><?php echo ucfirst ($member['Member']['nom']) ; ?> <?php echo ucfirst ($member['Member']['prenom']) ; ?></small></h4>
            </div>
        </div>
        <!-- /.row -->
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <img src="<?php echo '/uploads/members/'.$member['Member']['logo'] ; ?>" alt="<?php echo ucfirst ($member['Member']['nom']) ; ?> <?php echo ucfirst ($member['Member']['prenom']) ; ?>" class="img-circle profile-img" style = "height: 140px; width: 140px; ">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <table class="table table-striped">
                            	<tbody>
                                    <tr>
                                        <th>Projets</th>
                                        <td><small class="color-success">1</small></td>
                                    </tr>
                                    <tr>
                                        <th>Tâches</th>
                                        <td><small class="color-success">2</small></td>
                                    </tr>
                            		<tr>
                            			<th>Messages</th>
