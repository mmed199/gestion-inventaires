...
<div class="breadcrumb">
	<div class="breadcrumb_inset">
		...
		<span class="navigation_page"><a href="/demandes" title="Toutes les demandes" rel="tooltip">Demandes</a></span>
		<span class="navigation-pipe" >&gt;</span>
...
<section>
	...
	<div class="sortPagiBar shop_box_row shop_box_row_other clearfix">
		<?php echo $this->element('affiner_recherche'); ?>
	</div>
	<?php 
	if(empty($demandes)) echo '<p class="warning"><span><i class="icon-exclamation-sign"></i></span> Votre recherche n\'a donné aucun résultat</p>';
	else { ; ?>
				...
				<div class="row" style ="margin-left: 12px;">
					...
					<div class="clearfix back-divcontent"> 
						...
						<div class="div-transparent type">
							<a href="<?php echo $site_url."/demandes/".$d['Dcategory']['slug'] ."/".$d['Dtype']['slug']; ?>.html" title="">
								<span><?php echo $d['Dtype']['nom']; ?></span>
							</a>
						</div>
						<div class="div-transparent ville">
							<span class="small-menu">  <?php if(!empty($d['City']['nom']) ) : ?>/  <i class="icon-map-marker"></i> <?php echo $d['City']['nom']; ?><?php endif; ?>
							</span>
						</div>										
						<div style="float:right; padding:4px;">
							<?php if ($d['Demande']['reponse'] > 1){ ?>
						  	 		<span class="badge badge-info"><?php echo $d['Demande']['reponse']; ?> Réponses</span>
						  	<?php }elseif ($d['Demande']['reponse'] == 1){ ?>
						  	 	  	<span class="badge badge-info">Une Réponse</span>
						  	 <?php }; ?>
						</div>
						<div class="pull-left">		
							<a href="<?php echo $site_url."/demandes/".$d['Dcategory']['slug'] ."/".$d['Dtype']['slug'] ."/".$d['Demande']['slug']."-".$d['Demande']['id'].".html";?>" title="Voir détails" rel="tooltip" data-placement="bottom" data-original-title="<?php echo $d['Demande']['nom']; ?>" ><img  src="<?php echo "/uploads/demandes/".$d ['Demande']['image'];?>" alt="<?php echo $d['Dtype']['nom'] . " ". $d['Demande']['nom'];?>" class="img-polaroid cadre_img" /></a>
						</div>
						<div> 
							<div>
								<h3><span><a href="<?php echo $site_url."/demandes/".$d['Dcategory']['slug'] ."/".$d['Dtype']['slug'] ."/".$d['Demande']['slug']."-".$d['Demande']['id'].".html";?>" title="" ><?php echo $d['Demande']['nom']; ?></a></span></h3>		    
							    <!-- <span class="price"><img src="/img_all/icon/icon-price.png" alt="" /><?php echo number_format($d ['Demande']['budget'] , 0, '.', ' ');?>Dhs</span>	 -->	
								<div class="div-content-service">
									<?php echo $d ['Demande']['descDemande'] ; ?>
								</div>
								<div>
									<div class="small-menu  small-place">
										...
										<a href="#" onclick="window.open('http://www.facebook.com/sharer.php?u=<?php echo $site_url;?>&t=<?php echo $d['Demande']['nom']; ?>', 'Partager en Facebook'); return false;">
											<span class="icon small-menu"><i class="icon-white icon-facebook"></i> Partager</span>	
										</a>	
										<!-- <a href="#" onclick="window.open('http://twitter.com/share?text=<?php echo $site_url;?>&url=<?php echo $d['Demande']['nom']; ?>', 'Partager en Twitter'); return false;">
														<span class="icon small-menu"><i class="icon-white icon-twitter"></i> Twitter</span>	
													</a> -->			
									</div>				
									<p>	
										<a href="<?php echo $site_url."/demandes/".$d['Dcategory']['slug'] ."/".$d['Dtype']['slug'] ."/".$d['Demande']['slug']."-".$d['Demande']['id'].".html";?>" style ="float: right;">Voir détails &raquo;</a>
									</p>
