...
<html lang="en">
    <head>
        ...
        <title>ClicAdministration - Gestion Administratif - <?php echo (isset($page_title)?$page_title:"") ; ?></title>
                        ...
                        <div class="collapse navbar-collapse" id="navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav navbar-right" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                ...
                                <li class="dropdown tour-two">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $session->read('Auth.Member.nom');  ?> <span class="caret"></span></a>
                                    <ul class="dropdown-menu profile-dropdown">
                                        <li class="profile-menu bg-gray">
                                            <div class="">
                                                <img src="http://placehold.it/60/c2c2c2?text=User" alt="<?php echo $session->read('Auth.Member.nom');  ?>" class="img-circle profile-img">
                                                <div class="profile-name">
                                                    <h6><?php echo ucfirst($session->read('Auth.Member.nom'));  ?>
                                                    <?php echo ucfirst($session->read('Auth.Member.prenom'));  ?></h6>
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                                        </li>
                                        <li><a href="/member/members/index"><i class="fa fa-cog"></i> Détails du compte</a></li>
                                        <li role="separator" class="divider"></li>
                                        <li><a href="/deconnection.html" class="color-danger text-center"><i class="fa fa-sign-out"></i> Déconnecter</a></li>
                                    </ul>
                                </li>
                                <!-- /.dropdown -->
                    ...
                    <div class="left-sidebar fixed-sidebar bg-black-300 box-shadow tour-three">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="http://placehold.it/90/c2c2c2?text=User" alt="<?php echo $session->read('Auth.Member.nom');  ?>" class="img-circle profile-img">
                                <h6 class="title"><?php echo $session->read('Auth.Member.nom');  ?> <?php echo $session->read('Auth.Member.prenom');  ?></h6>
                                <small class="info"><?php echo $session->read('Auth.Member.titre_activite');  ?></small>
                            </div>
                            <!-- /.user-info -->

                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    <li class=""><a href="/"><i class="fa fa-home"></i> <span>Accueil</span></a></li>

                                    <li class="nav-header">
                                        <span class="">Rubriques</span>
                                    </li>
                                    <li class="has-children">
                                        <a href="/gestion-activites.html"><i class="fa fa-line-chart"></i> <span>Gestion activité</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="/member/dossiers/index"><i class="fa fa-folder"></i> <span>Gestion des dossiers</span></a></li>
                                            <li><a href="/member/projets/index"><i class="fa fa-check-square-o"></i> <span>Gestion des projets</span></a></li>
                                            <li><a href="/gestion-temps.html"><i class="fa fa-calendar-check-o"></i> <span>Gestion des temps</span></a></li>
                                            <li><a href="/planning.html"><i class="fa fa-bars"></i> <span>Planning</span></a></li>
                                        </ul>
                                    </li>
                                    <li class="has-children">
                                        <a href="/gestion-stocks.html"><i class="fa fa-truck"></i> <span>Gestion de stocks </span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li>
                                                <a href="/member/vehicules/index"><i class="fa fa-car"></i> <span>Gestion Parc-Auto</span></a>
                                            </li>
                                            <li>
                                                <a href="/member/inventaires/index"><i class="fa fa-barcode"></i> <span>Inventaires</span></a>
                                            </li>
                                            <li>
                                                <a href="/member/produits/index"><i class="fa fa-shopping-cart"></i> <span>Catalogue de produits</span></a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="has-children">
                                        <a href="/gestion-rh.html"><i class="fa fa-users"></i> <span>Gestion RH</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="/gestion-absences.html"><i class="fa fa-clock-o"></i> <span>Gestion des absences</span></a></li>
                                            <li><a href="/gestion-profils"><i class="fa fa-user"></i> <span>Gestion des profils</span></a></li>
                                        </ul>
                                    </li>
                                    <li class="has-children">
                                        <li class="">
                                        	<a href="/ged.html"><i class="fa fa-globe"></i></i> <span>GED</span></a>
                                        </li>
                                    </li>
