                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">
                                ...
                                <!-- Refusée = 3 / Accord Partiel = 2  / Accordée = 1 / En cours de tratement = 0 par default -->
                                <?php if($absence['Absence']['decision']==3) { ?> 

                                    <h6>Votre décision: <span class='label label-danger label-wide'> Refusée </span></h6> 
                                    
                                    <?php }else if ($absence['Absence']['decision']==1) { ?>
                                   
                                    <h6>Votre décision: <span class='label label-success label-wide'> Accordée </span></h6> 

                                    <?php }else if ($absence['Absence']['decision']==2 && $absence['Absence']['satisfaction']==0) { ?>

                                    <h6>Votre décision: <span class='label label-warning label-wide'> Accord Partiel </span></h6> 
                                    <br> 
                                <?php } ?>           
                                
                                <?php if ($absence['Absence']['decision']==2 && $absence['Absence']['satisfaction']==1) { ?>
                                   
                                    <h6>Stauts: <span class='label label-default label-wide'>Satisfaction envoyée </span></h6>
                                  
                                    <?php } else if ($absence['Absence']['decision']==0) { ?>

                                    <h6>Stauts: <span class='label label-default label-wide'>En cours de traitement </span></h6>
                        ...
                        <div class="panel-body">
                            <div class="col-md-12 mt-15">
                               ...
                               <strong>Date fin: </strong> <?php echo strftime( "%d/%m/%Y" , strtotime($absence['Absence']['date_fin'])) ; ?><br>
                                ...
                                <?php if($absence['Absence']['decision']==2 && $absence['Absence']['envoyer']==1) { ?> 
