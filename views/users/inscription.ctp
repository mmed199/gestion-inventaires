            ...
            <div class="panel login-box">
                ...
                <div class="panel-body p-20">
                    ...
                    <div class="section-title">
                        <p class="sub-title text-muted">Créez un compte Admin.</p>
                    </div>
                    <?php echo $session->flash() ; ?>
                    <?php echo $form->create('User',array('action'=>'inscription')); ?>
                        ...
                        <div class="form-group mt-20">
                            <div class="">
                                <button type="submit" class="btn btn-success btn-labeled pull-right"> Créer <span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
